...
<ListItemText sx={{fontSize:'12px', marginLeft:'10px', color:'#131e47'}}>Home</ListItemText>
        </ListItemIcon>
    </ListItemButton>
    </Link>
...
<ListItemText sx={{fontSize:'10px', marginLeft:'10px', color:'#131e47'}}>College of Engineer</ListItemText>
        </ListItemIcon>
    </ListItemButton>
    </Link>
...
<ListItemText sx={{fontSize:'10px', marginLeft:'10px', color:'#131e47'}}>College of Data</ListItemText>
        </ListItemIcon>
    </ListItemButton>
    </Link>
    <Link href='/Design'>
...
<ListItemText sx={{fontSize:'10px', marginLeft:'10px', color:'#131e47'}}>College of Design</ListItemText>
        </ListItemIcon>
    </ListItemButton>
    </Link>
...
<ListItemText sx={{fontSize:'12px', marginLeft:'10px', color:'#131e47'}}>Faq</ListItemText>
        </ListItemIcon>
    </ListItemButton>
    </Link>
<Divider/>
...
<ListItemText sx={{fontSize:'12px', marginLeft:'10px', color:'#131e47'}}>Sign Up</ListItemText>
        </ListItemIcon>
    </ListItemButton>
    </Link>
